...
object ParserGeneratorPlugin extends AutoPlugin {
  ...
  override lazy val projectSettings: Seq[Setting[_]] = Seq(
    ...
    generateParserTemplate / fileInputs := Seq(codegenDirectory.value.jfile.toGlob),
    ...
    generateParserSource / fileInputs := Seq(outputTemplateDirectory.value.jfile.toGlob),
